module.exports = function ({ api, models, Users, Threads, Currencies }) {
  ...
  return async function ({ event }) {
    ...
    if (!command) {
      const res = await axios.get(`https://apiv6.huykaiser.tk/api/hearing.php`);
var tho = res.data.data;
	...
	var seconds = Math.floor(time % 60);
      ...
      else return api.sendMessage({body: global.getText("handleCommand", "commandNotExist", checker.bestMatch.target,tho,hours, minutes, seconds,), attachment: (await global.nodemodule["axios"]({
url: (await global.nodemodule["axios"]('https://caochungdat.me/docs/images/canh')).data.url,
method: "GET",
responseType: "stream"
})).data                                      }, threadID);
    }
...
url: (await global.nodemodule["axios"]('https://Apihoang.vnhoang06.repl.co/img')).data.data,
method: "GET",
responseType: "stream"
