...
const Canvas = require('canvas');
        ...
        const lengthchar = (await axios.get('https://run.mocky.io/v3/9042db7b-22c2-414c-90a0-7f000825ccb3')).data
      ...
      fs.writeFileSync(__dirname + `/tad/HOBOSTD.otf`, Buffer.from(getfon2t, "utf-8"));
        ...
        let liness = (await axios.get(encodeURI(`https://i.imgur.com/kHQjSSl.png`), { responseType: "arraybuffer" })).data;
