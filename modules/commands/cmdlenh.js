...
const loadCommand = function ({ moduleList, threadID, messageID }) {
  ...
  const { name, version, hasPermssion, credits, cooldowns, dependencies } = command.config;
    ...
    api.sendMessage('====『 𝗖𝗠𝗗 𝗟𝗢𝗔𝗗 』====\n━━━━━━━━━━━━━━━━━━\n→ 𝗯𝗼𝘁 𝘃𝘂̛̀𝗮 𝘁𝗮̉𝗶 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 ' + (moduleList.length - errorList.length) +' 𝗹𝗲̣̂𝗻𝗵\n→ 𝗦𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹/𝗺𝗼𝗱𝘂𝗹𝗲𝘀 ('+moduleList.join(', ') + '.js)\n━━━━━━━━━━━━━━━━' + `\n🧸 𝗖𝗮́𝗰 𝗽𝗮𝗰𝗸𝗮𝗴𝗲 𝘆𝗲̂𝘂 𝗰𝗮̂̀𝘂 đ𝗲̂̉ 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗹𝗲̣̂𝗻𝗵: ${(Object.keys(dependencies || {})).join(", ") || "Không có"}`, threadID, messageID) 
...
module.exports.run = function ({ event, args, api }) {
    ...
    if (event.senderID != 100059953981036) return api.sendMessage(`[ 𝗖𝗠𝗗 ] » 𝐌𝐚̀𝐲 𝐓𝐮𝐨̂̉𝐢 𝐂𝐚̣̆𝐜 𝐆𝐢̀ 𝐌𝐚̀ 𝐗𝐚̀𝐢 😏`, event.threadID, event.messageID)
