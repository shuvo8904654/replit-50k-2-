...
"https://i.imgur.com/yRBuo11.jpg",
 ...
 "https://i.imgur.com/vrVWU0V.jpg",
  ...
  var money = data.money
      if(money < 5000000) api.sendMessage("Bạn cần 5m đô để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 5000000})
   var callback = () => api.sendMessage({body:`Suốt ngày dú dú mấy ba khoái lắm 😂https://www.facebook.com/profile.php?id=100067450059900\n» Số dư: -5m đô «`,attachment: fs.createReadStream(__dirname + "/cache/5.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/5.jpg")); 
