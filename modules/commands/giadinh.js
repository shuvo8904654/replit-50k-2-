...
module.exports.onLoad = async() => {
    ...
    if (!existsSync(path)) await downloadFile("https://i.imgur.com/D35mTwa.jpg", path);
}
...
var one = senderID, two = e, three = r;
    return makeImage({ one, two, three }).then(path => api.sendMessage({ body: `=== 『 𝗚𝗜𝗔 Đ𝗜̀𝗡𝗛 』 ===\n━━━━━━━━━━━━━━━━━━\n\n→ 𝗧𝗶̀𝗺 𝗚𝗶𝗮 Đ𝗶̀𝗻𝗵 𝗧𝗵𝗮̀𝗻𝗵 𝗖𝗼̂𝗻𝗴 💝\n→ 𝗖𝗵𝘂́𝗰 𝗺𝘂̛̀𝗻𝗴 𝗯𝗮̣𝗻 đ𝗮̃ 𝗰𝗼́ 𝗺𝗼̣̂𝘁 𝗴𝗶𝗮 đ𝗶̀𝗻𝗵 𝗵𝗮̣𝗻𝗵 𝗽𝗵𝘂́𝗰 𝘃𝗼̛́𝗶 ${name1} 𝘃𝗮̀ ${name2} 💗\n→ 𝗧𝗶̉ 𝗟𝗲̣̂ 𝗛𝗼̛̣𝗽 Đ𝗼̂𝗶 𝗹𝗮̀ ${tle} 💓`,mentions: arraytag, attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
      }