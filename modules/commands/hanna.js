...
module.exports.config = {
  ...
  hasPermssion: 0,
  credits: "HungCho",
  description: "Randon Ảnh Hanna UwU",
...
var min = Math.floor(Math.random() * 2);
  ...
  var money = data.money
      if(money < 500) api.sendMessage("→ 𝗕𝗮̣𝗻 𝗰𝗮̂̀𝗻 𝟱𝟬𝟬 đ𝗼̂ đ𝗲̂̉ 𝘅𝗲𝗺 𝗮̉𝗻𝗵 ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 500})
   var callback = () => api.sendMessage({body:`=== 『 𝗔̉𝗡𝗛 𝗛𝗔𝗡𝗡𝗔 』 ====\n━━━━━━━━━━━━━━━━━━\n\n→ 𝗔̉𝗻𝗵 𝗵𝗮𝗻𝗻𝗮 𝗨𝘄𝗨\n→ 𝗦𝗼̂́ 𝗔̉𝗻𝗵: ${link.length}\n→ -𝟱𝟬𝟬 đ𝗼̂ !`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID); 
