...
if(!mentions1) { 
  ...
  if(args[0] == "info"){return api.sendMessage(`©Code By VNH Epdaii\n©Design By VNH epdaii\n\n=============\n- Hỗ trợ code: co con cac\n- Ý tưởng: co con cac\n\n=============\nNếu muốn góp ý tính năng vui lòng inbox https://m.me/100059953981036`,event.threadID,event.messageID)}
