...
module.exports.handleEvent = async ({ Users, api, event})=> {
  ...
  const so_lan_spam = 35; // số lần spam, vượt quá sẽ bị ban
	...
	if ((global.client.autoban[senderID].timeStart + thoi_gian_spam) <= Date.now()) {
	  ...
	  if (global.client.autoban[senderID].number >= so_lan_spam) {
	    const moment = require("moment-timezone");
  		...
  		api.sendMessage({
  		  body: "[🌸] 𝗧𝗲̂𝗻: " + dataUser.name + "\n[🎀] 𝗜𝗗: " + senderID + `\n➣ 𝗕𝗶̣ 𝗰𝗮̂́𝗺 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 𝗕𝗼𝘁 ${unbanAfter/600000} 𝗽𝗵𝘂́𝘁 𝘃𝗼̛́𝗶 𝗹𝗶́ 𝗱𝗼 𝘀𝗽𝗮𝗺 𝗕𝗼𝘁 15 𝗹𝗮̂̀𝗻/1 𝗽𝗵𝘂́𝘁\n➣ 𝗛𝗮̃𝘆 𝗻𝗼́𝗶 𝗹𝗼̛̀𝗶 𝘁𝗿𝗮̆𝗻 𝘁𝗿𝗼̂́𝗶 𝘁𝗼̛́𝗶 𝗔𝗱𝗺𝗶𝗻, 𝗕𝗼𝘁 𝘀𝗲̃ 𝗮𝘂𝘁𝗼 𝗴𝗼̛̃ 𝗯𝗮𝗻 ${Math.floor(unbanAfter/600000)} 𝗽𝗵𝘂́𝘁 𝗻𝘂̛̃𝗮\n𝗡𝗲̂́𝘂 𝗹𝗮̀ 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗾𝘂𝗲𝗻 𝗵𝗮̃𝘆 𝗶𝗻𝗯𝗼𝘅 𝗮𝗱𝗺𝗶𝗻 𝘀𝗵𝗼𝘄 𝗱𝘂́ 𝗻𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝗴𝗼̛̃ 𝗕𝗮𝗻 𝗧𝗿𝘂̛𝗼̛́𝗰 𝟮𝟭𝗵 𝗧𝗼̂́𝗶 𝗛𝗮̆̀𝗻𝗴 𝗡𝗴𝗮̀𝘆\n Facebook Admin Đây m.me/BVL.2009\n[⏰] 𝗧𝗵𝗼̛̀𝗶 𝗴𝗶𝗮𝗻: ${time}\n[📲] 𝗚𝘂̛̉𝗶 𝘁𝗶𝗻 𝗻𝗵𝗮̆́𝗻 𝘁𝗼̛́𝗶 𝗰𝗮́𝗰 𝗔𝗱𝗺𝗶𝗻 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴`,
