...
let l1 = await loadImage(pathAva);
  ...
  ctx.drawImage(l1, -350, -100, 1200, 1200);
    ...
    ctx.fillText("Nguyễn Sơn", 1095, 440);
    ctx.beginPath();
  ////////////////////////////////////////
  ...
  registerFont(__dirname + `/tad/Asem-Kandis-PERSONAL-USE.ttf`, {
      ...
      ctx.fillText("#" + "Be Van Luc", 100, 100)
      ctx.restore();
      ctx.save();
registerFont(__dirname + `/tad/CaviarDreams.ttf`, {
    ...
    ctx.textAlign = "start";
    ctx.font = "45px time";
    ctx.fillText("@" + "Be Van Luc", 1180, 615)
    ctx.fillText("@" + "Be Van Luc", 1180, 685)
   ctx.fillText("@" + "Be Van Luc", 1180, 750)
    ctx.restore();
    ctx.save();
    ctx.beginPath();
